...
const About = () => {
   return (
      <div>
         ...
         <div className="my-10 flex flex-column md:flex-row gap-12">
            <img
               className="w-full md:max-w-[360px]"
               src={assets.about_image}
               alt=""
            />
            <div className="flex-column justify-center gap-6 md:w-2/4 text-sm text-gray-600">
               <p className="mt-6">
               ...
               <b className="mt-6 text-gray-800">Our Vision</b>
               <p className="mt-6">
         ...
         <div className="flex flex-column md:flex-row mb-20">
            <div className="border px-5 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-blue-500 text-black transition-all duration-600 text-gray-600 cursor-pointer">
               <b>Efficiency:</b>
               <p>
